...
export default function ListItem({ todo, id, checkComplete, handleEditTodos }) { // bunu bu sekilde destructuring yaptık. ani propsla gelen degerleri bu sekilde kullanacagiz
